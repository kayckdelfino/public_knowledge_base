# Challenge statement: https://www.hackerrank.com/challenges/py-set-mutations/problem
# 
...
if __name__ == "__main__":
    ...
    for i in range(N):
        ...
        if operation == "intersection_update": set_A &= set_B
        elif operation == "update": set_A |= set_B
        elif operation == "symmetric_difference_update": set_A ^= set_B
        elif operation == "difference_update": set_A -= set_B
