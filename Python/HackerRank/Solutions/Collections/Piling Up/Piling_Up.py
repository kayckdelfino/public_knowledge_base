# Challenge statement: https://www.hackerrank.com/challenges/piling-up/problem
# 
...
def is_stackable(cubes_deque):
    last = float("inf")
    
    while cubes_deque:
        if cubes_deque[0] >= cubes_deque[-1]:
            current = cubes_deque.popleft()
        else:
            current = cubes_deque.pop()
