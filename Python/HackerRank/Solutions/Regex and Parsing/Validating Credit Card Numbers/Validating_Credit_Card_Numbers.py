# Challenge statement: https://www.hackerrank.com/challenges/validating-credit-card-number/problem
# 
...
def is_valid(card_number):
    valid_reg = r"^[456]\d{3}(-?\d{4}){3}$"
    invalid_reg = r"(\d)\1{3,}"
    
    if re.match(valid_reg, card_number) and not re.search(invalid_reg, card_number.replace("-", "")):
        return "Valid"
    else:
        return "Invalid"
