/*
Crie uma classe Livro, que implementa essa interface (Comparavel) e possui um atributo: nome (literal). Ao comparar objetos dessa classe deve-se levar em conta para o retorno do método comparar a ordem alfabética do nome do livro.
*/

package ExComparator.Ex02;
