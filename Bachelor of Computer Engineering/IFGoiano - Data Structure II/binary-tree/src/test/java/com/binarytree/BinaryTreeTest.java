...
class BinaryTreeTest {
    ...
    void performASetOfRemovals() {
        ...
        assertEquals(binaryTreeOps.toString(rootNode),  "root:37 (left:20 (left:10 (left:5 )right:30 )right:80 (right:100 (left:90 right:180 )))");

        binaryTreeOps.remove(rootNode, 180);
        assertEquals(binaryTreeOps.toString(rootNode), "root:37 (left:20 (left:10 (left:5 )right:30 )right:80 (right:100 (left:90 )))");

        binaryTreeOps.remove(rootNode, 80);
        assertEquals(binaryTreeOps.toString(rootNode), "root:37 (left:20 (left:10 (left:5 )right:30 )right:100 (left:90 ))");
        ...
        binaryTreeOps.remove(rootNode, 5);
        assertEquals(binaryTreeOps.toString(rootNode), "root:100 (left:90 (left:30 ))");

        binaryTreeOps.remove(rootNode, 100);
        assertEquals(binaryTreeOps.toString(rootNode), "root:90 (left:30 )");
    }
