...
# Challenge statement: https://www.hackerrank.com/challenges/text-processing-in-linux-the-grep-command-1/problem
# 
# Objective
# In this challenge, we practice using the grep command to find specified strings or regular expressions.
# 
# Resources
# Here's a [useful video](https://www.youtube.com/watch?v=WX5Zfflvdt0) on the topic
# 
