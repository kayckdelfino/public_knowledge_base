...
# Challenge statement: https://www.hackerrank.com/challenges/text-processing-in-linux-the-grep-command-5/problem
# 
...
# 
# More details about common examples of grep usage may be read [here](https://tldp.org/LDP/abs/html/textproc.html).
# 
