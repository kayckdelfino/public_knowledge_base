...
# Challenge statement: https://www.hackerrank.com/challenges/sed-command-4/problem
# 
...
# 
# - [Sed: An Introduction and Tutorial](www.grymoire.com/Unix/Sed.html#uh-10a)
...
# - A tutorial from [TheGeekStuff](www.thegeekstuff.com/2009/10/unix-sed-tutorial-advanced-sed-substitution-examples/) detailing the use of groups and backreferences.
# 
# Input Format
